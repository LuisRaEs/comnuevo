...
export class Device {
   ...
   * @returns {Promise<Response>}
   */
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      if (typeof args != "string" && args?.qwery != undefined) {
        args = args.qwery;
      }
      findDevice(args, graphql)
        .then((response) => {
          const newArray = [];
...
export class Grupos {
  ...
  assingLogotipoFile(args) {
    return assingLogotipoFiletoGrupos(args, this.ID);
  }

  assingCabeceraFile(args) {
    return assingCabeceraFiletoGrupos(args, this.ID);
  }
   ...
   * @method
   * @returns {Attachment} The LogotipoFile of Grupos
   */
  getLogotipoFile() {
   ...
   * @method
   * @param {Attachment} value - The LogotipoFile of Grupos
   * @returns The original Grupos(this object)
   */
  setLogotipoFile(value) {
    //object based
    if (value == null || value == undefined || value instanceof Attachment)
   ...
   * @method
   * @returns {Attachment} The CabeceraFile of Grupos
   */
  getCabeceraFile() {
   ...
   * @method
   * @param {Attachment} value - The CabeceraFile of Grupos
   * @returns The original Grupos(this object)
   */
...
export class Compania {
  constructor(obj) {
    ...
    /**
     * @type {Catalogo_Idioma}
     */
    this.Idioma = undefined;
    /**
     * @type {Catalogo_ZonaHoraria}
     */
  ...
  assingIdioma(args) {
    return assingIdiomatoCompania(args, this.ID);
  }

  assingZonaHorarial(args) {
    return assingZonaHorarialtoCompania(args, this.ID);
  }

  assingLogo1(args) {
    return assingLogo1toCompania(args, this.ID);
  }

  assingLogo2(args) {
    return assingLogo2toCompania(args, this.ID);
  }
   ...
   * @method
   * @returns {Catalogo_Idioma} The Idioma of Compania
   */
  getIdioma() {
    return this.Idioma;
  }
   ...
   * @method
   * @param {Catalogo_Idioma} value - The Idioma of Compania
   * @returns The original Compania(this object)
   */
  setIdioma(value) {
    //object based
    if (value == null || value == undefined || value instanceof Catalogo_Idioma)
      this.Idioma = value;
    else throw new Error("Wrong value type");
    return this;
  }
   ...
   * @method
   * @returns {Catalogo_ZonaHoraria} The ZonaHorarial of Compania
   */
  getZonaHorarial() {
   ...
   * @method
   * @param {Catalogo_ZonaHoraria} value - The ZonaHorarial of Compania
   * @returns The original Compania(this object)
   */
  setZonaHorarial(value) {
    ...
    if (
      value == null ||
      value == undefined ||
      value instanceof Catalogo_ZonaHoraria
    )
   ...
   * @method
   * @returns {Date} The HoraInicio of Compania
   */
  getHoraInicio() {
   ...
   * @method
   * @param {Date} value - The HoraInicio of Compania
   * @returns The original Compania(this object)
   */
  ...
  setHoraInicio(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.HoraInicio = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
   ...
   * @method
   * @returns {Date} The HoraFin of Compania
   */
  getHoraFin() {
    return this.HoraFin;
  }
   ...
   * @method
   * @param {Date} value - The HoraFin of Compania
   * @returns The original Compania(this object)
   */
  ...
  setHoraFin(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.HoraFin = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
   ...
   * @method
   * @returns {Attachment} The Logo1 of Compania
   */
  getLogo1() {
    return this.Logo1;
  }
   ...
   * @method
   * @param {Attachment} value - The Logo1 of Compania
   * @returns The original Compania(this object)
   */
  setLogo1(value) {
    //object based
   ...
   * @method
   * @returns {Attachment} The Logo2 of Compania
   */
  getLogo2() {
    return this.Logo2;
  }
   ...
   * @method
   * @param {Attachment} value - The Logo2 of Compania
   * @returns The original Compania(this object)
   */
  setLogo2(value) {
    //object based
...
export class Noticia {
  ...
  assingLogo(args) {
    return assingLogotoNoticia(args, this.ID);
  }
   ...
   * @method
   * @returns {Attachment} The Logo of Noticia
   */
  getLogo() {
    return this.Logo;
  }
   ...
   * @method
   * @param {Attachment} value - The Logo of Noticia
   * @returns The original Noticia(this object)
   */
  setLogo(value) {
    //object based
   ...
   * @method
   * @returns {Date} The Fecha of Noticia
   */
  getFecha() {
    return this.Fecha;
  }
   ...
   * @method
   * @param {Date} value - The Fecha of Noticia
   * @returns The original Noticia(this object)
   */
  ...
  setFecha(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.Fecha = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
...
export class TareaOnBoarding {
  ...
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findTareaOnBoarding(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
   ...
   * @method
   * @returns {Attachment} The Documento of TareaOnBoarding
   */
  getDocumento() {
   ...
   * @method
   * @param {Attachment} value - The Documento of TareaOnBoarding
   * @returns The original TareaOnBoarding(this object)
   */
  setDocumento(value) {
    //object based
...
export class RegistroAusencia {
  ...
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findRegistroAusencia(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
   ...
   * @method
   * @returns {Date} The FechaDeSolicitud of RegistroAusencia
   */
  getFechaDeSolicitud() {
   ...
   * @method
   * @param {Date} value - The FechaDeSolicitud of RegistroAusencia
   * @returns The original RegistroAusencia(this object)
   */
  ...
  setFechaDeSolicitud(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaDeSolicitud = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
   ...
   * @method
   * @returns {Date} The FechaAprobada of RegistroAusencia
   */
  getFechaAprobada() {
   ...
   * @method
   * @param {Date} value - The FechaAprobada of RegistroAusencia
   * @returns The original RegistroAusencia(this object)
   */
  ...
  setFechaAprobada(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaAprobada = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
   ...
   * @method
   * @returns {Date} The FechaSolicitadaInicio of RegistroAusencia
   */
   ...
   * @method
   * @param {Date} value - The FechaSolicitadaInicio of RegistroAusencia
   * @returns The original RegistroAusencia(this object)
   */
  ...
  setFechaSolicitadaInicio(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaSolicitadaInicio = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
   ...
   * @method
   * @returns {Date} The FechaSolicitadaFin of RegistroAusencia
   */
   ...
   * @method
   * @param {Date} value - The FechaSolicitadaFin of RegistroAusencia
   * @returns The original RegistroAusencia(this object)
   */
  ...
  setFechaSolicitadaFin(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaSolicitadaFin = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
   ...
   * @method
   * @returns {Date} The FechaRecuperadaInicio of RegistroAusencia
   */
   ...
   * @method
   * @param {Date} value - The FechaRecuperadaInicio of RegistroAusencia
   * @returns The original RegistroAusencia(this object)
   */
  ...
  setFechaRecuperadaInicio(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaRecuperadaInicio = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
   ...
   * @method
   * @returns {Date} The FechaRecuperadaFin of RegistroAusencia
   */
   ...
   * @method
   * @param {Date} value - The FechaRecuperadaFin of RegistroAusencia
   * @returns The original RegistroAusencia(this object)
   */
  ...
  setFechaRecuperadaFin(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaRecuperadaFin = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
...
export class Ausencia {
  ...
  addGrupos(args) {
    return addGrupostoAusencia(args, this.ID);
  }
  ...
  /**
   * Get the GoceSueldo of Ausencia
   * @method
   * @returns {boolean} The GoceSueldo of Ausencia
   */
  getGoceSueldo() {
    return this.GoceSueldo;
  }
  /**
   * Sets the GoceSueldo of Ausencia
   * @method
   * @param {boolean} value - The GoceSueldo of Ausencia
   * @returns The original Ausencia(this object)
   */
   ...
   * @method
   * @returns {Date} The FechaActivacion of Ausencia
   */
  getFechaActivacion() {
   ...
   * @method
   * @param {Date} value - The FechaActivacion of Ausencia
   * @returns The original Ausencia(this object)
   */
  ...
  setFechaActivacion(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaActivacion = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
   ...
   * @method
   * @returns {Date} The FechaFinalizacion of Ausencia
   */
   ...
   * @method
   * @param {Date} value - The FechaFinalizacion of Ausencia
   * @returns The original Ausencia(this object)
   */
  ...
  setFechaFinalizacion(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaFinalizacion = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
...
export class Comentario {
   ...
   * @method
   * @returns {Date} The Fecha of Comentario
   */
  getFecha() {
    return this.Fecha;
  }
   ...
   * @method
   * @param {Date} value - The Fecha of Comentario
   * @returns The original Comentario(this object)
   */
...
export class Registro {
   ...
   * @method
   * @returns {Date} The Fecha of Registro
   */
  getFecha() {
    return this.Fecha;
  }
   ...
   * @method
   * @param {Date} value - The Fecha of Registro
   * @returns The original Registro(this object)
   */
...
export class ConfiguracionRetardos {
  ...
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findConfiguracionRetardos(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
...
export class JornadaExcepcion {
  ...
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findJornadaExcepcion(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
...
export class ConfiguracionJornadaEspecifica {
  ...
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findConfiguracionJornadaEspecifica(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
   ...
   * @method
   * @returns {Date} The FechaExcepcionIni of ConfiguracionJornadaEspecifica
   */
   ...
   * @method
   * @param {Date} value - The FechaExcepcionIni of ConfiguracionJornadaEspecifica
   * @returns The original ConfiguracionJornadaEspecifica(this object)
   */
  ...
  setFechaExcepcionIni(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaExcepcionIni = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
   ...
   * @method
   * @returns {Date} The FechaExcepcionFin of ConfiguracionJornadaEspecifica
   */
   ...
   * @method
   * @param {Date} value - The FechaExcepcionFin of ConfiguracionJornadaEspecifica
   * @returns The original ConfiguracionJornadaEspecifica(this object)
   */
  ...
  setFechaExcepcionFin(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaExcepcionFin = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
...
export class ViviendaHabitual {
  ...
  /**
   * Crea un nuevo objeto ViviendaHabitual
   * @method
   * @returns {Promise<Response>}
   */
  crear() {
    return new Promise((resolve, reject) => {
      createViviendaHabitual(this)
        .then((response) => {
          this.ID = response.value;
          resolve(response);
        })
  ...
  /**
   * Busca ViviendaHabitual's con las mismas propiedades que este objeto
   * @method
   * @returns {Promise<Response>}
   */
  searchLikeMe() {
    return ViviendaHabitual.buscar(this);
  }
  /**
   * Busca ViviendaHabitual's, puedes usar {qwery:"<mysqlquery>"} o {qwery:"<mysqlquery>",graphql="<propiedades>"}
   * @method
   * @returns {Promise<Response>}
   */
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findViviendaHabitual(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
            newArray.push(new ViviendaHabitual(element))
          );
          response.Value = newArray;
          resolve(response);
        })
  ...
  actualizar() {
    return new Promise((resolve, reject) => {
      resolve(updateViviendaHabitual(this));
    });
  }
  /**
   * Elimina la
   ...
   */
  eliminar() {
    return deleteViviendaHabitual({ id: this.ID.toString() });
  }
  main_ViviendaHabitual(args) {
    return main_ViviendaHabitual(args, this.ID);
  }

  /**
   * Get the Pais of ViviendaHabitual
   * @method
   * @returns {string} The Pais of ViviendaHabitual
   */
  getPais() {
    return this.Pais;
  }
  /**
   * Sets the Pais of ViviendaHabitual
   * @method
   * @param {string} value - The Pais of ViviendaHabitual
   * @returns The original ViviendaHabitual(this object)
   */
  ...
  /**
   * Get the Estado of ViviendaHabitual
   * @method
   * @returns {string} The Estado of ViviendaHabitual
   */
  getEstado() {
    return this.Estado;
  }
  /**
   * Sets the Estado of ViviendaHabitual
   * @method
   * @param {string} value - The Estado of ViviendaHabitual
   * @returns The original ViviendaHabitual(this object)
   */
  ...
  /**
   * Get the Ciudad of ViviendaHabitual
   * @method
   * @returns {string} The Ciudad of ViviendaHabitual
   */
  getCiudad() {
    return this.Ciudad;
  }
  /**
   * Sets the Ciudad of ViviendaHabitual
   * @method
   * @param {string} value - The Ciudad of ViviendaHabitual
   * @returns The original ViviendaHabitual(this object)
   */
  ...
  /**
   * Get the CodigoPostal of ViviendaHabitual
   * @method
   * @returns {string} The CodigoPostal of ViviendaHabitual
   */
  getCodigoPostal() {
    return this.CodigoPostal;
  }
  /**
   * Sets the CodigoPostal of ViviendaHabitual
   * @method
   * @param {string} value - The CodigoPostal of ViviendaHabitual
   * @returns The original ViviendaHabitual(this object)
   */
  ...
  /**
   * Get the Direccion of ViviendaHabitual
   * @method
   * @returns {string} The Direccion of ViviendaHabitual
   */
  getDireccion() {
    return this.Direccion;
  }
  /**
   * Sets the Direccion of ViviendaHabitual
   * @method
   * @param {string} value - The Direccion of ViviendaHabitual
   * @returns The original ViviendaHabitual(this object)
   */
...
export class Contacto {
  ...
  /**
   * Busca Contacto's con las mismas propiedades que este objeto
   * @method
   * @returns {Promise<Response>}
   */
  searchLikeMe() {
    return Contacto.buscar(this);
  }
  /**
   * Busca Contacto's, puedes usar {qwery:"<mysqlquery>"} o {qwery:"<mysqlquery>",graphql="<propiedades>"}
   * @method
   * @returns {Promise<Response>}
   */
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findContacto(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
            newArray.push(new Contacto(element))
          );
          response.Value = newArray;
          resolve(response);
        })
   ...
   */
  eliminar() {
    return deleteContacto({ id: this.ID.toString() });
  }
  main_Contacto(args) {
    return main_Contacto(args, this.ID);
  }

  /**
   * Get the Nombre of Contacto
   * @method
   * @returns {string} The Nombre of Contacto
   */
  getNombre() {
    return this.Nombre;
  }
  /**
   * Sets the Nombre of Contacto
   * @method
   * @param {string} value - The Nombre of Contacto
   * @returns The original Contacto(this object)
   */
  ...
  /**
   * Get the Relacion of Contacto
   * @method
   * @returns {number} The Relacion of Contacto
   */
  getRelacion() {
    return this.Relacion;
  }
  /**
   * Sets the Relacion of Contacto
   * @method
   * @param {number} value - The Relacion of Contacto
   * @returns The original Contacto(this object)
   */
  ...
  /**
   * Get the Tipo of Contacto
   * @method
   * @returns {number} The Tipo of Contacto
   */
  getTipo() {
    return this.Tipo;
  }
  /**
   * Sets the Tipo of Contacto
   * @method
   * @param {number} value - The Tipo of Contacto
   * @returns The original Contacto(this object)
   */
  ...
  /**
   * Get the CelularLada of Contacto
   * @method
   * @returns {number} The CelularLada of Contacto
   */
  getCelularLada() {
    return this.CelularLada;
  }
  /**
   * Sets the CelularLada of Contacto
   * @method
   * @param {number} value - The CelularLada of Contacto
   * @returns The original Contacto(this object)
   */
  ...
  /**
   * Get the Celular of Contacto
   * @method
   * @returns {string} The Celular of Contacto
   */
  getCelular() {
    return this.Celular;
  }
  /**
   * Sets the Celular of Contacto
   * @method
   * @param {string} value - The Celular of Contacto
   * @returns The original Contacto(this object)
   */
  ...
  /**
   * Get the Email of Contacto
   * @method
   * @returns {string} The Email of Contacto
   */
  getEmail() {
    return this.Email;
  }
  /**
   * Sets the Email of Contacto
   * @method
   * @param {string} value - The Email of Contacto
   * @returns The original Contacto(this object)
   */
...
export class Usuario {
  ...
  assingIdioma(args) {
    return assingIdiomatoUsuario(args, this.ID);
  }

  assingPuesto(args) {
    return assingPuestotoUsuario(args, this.ID);
  }

  assingDepartamento(args) {
    return assingDepartamentotoUsuario(args, this.ID);
  }

  assingDirectivo(args) {
    return assingDirectivotoUsuario(args, this.ID);
  }
   ...
   * @method
   * @returns {Date} The FechaDeNacimiento of Usuario
   */
   ...
   * @method
   * @param {Date} value - The FechaDeNacimiento of Usuario
   * @returns The original Usuario(this object)
   */
  ...
  setFechaDeNacimiento(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaDeNacimiento = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
  ...
  /**
   * Get the Direccion of Usuario
   * @method
   * @returns {string} The Direccion of Usuario
   */
  getDireccion() {
    return this.Direccion;
  }
  /**
   * Sets the Direccion of Usuario
   * @method
   * @param {string} value - The Direccion of Usuario
   * @returns The original Usuario(this object)
   */
   ...
   * @method
   * @returns {number} The Genero of Usuario
   */
  getGenero() {
    return this.Genero;
  }
   ...
   * @method
   * @param {number} value - The Genero of Usuario
   * @returns The original Usuario(this object)
   */
  ...
  /**
   * Get the Idioma of Usuario
   * @method
   * @returns {Catalogo_Idioma} The Idioma of Usuario
   */
  getIdioma() {
    return this.Idioma;
  }
  /**
   * Sets the Idioma of Usuario
   * @method
   * @param {Catalogo_Idioma} value - The Idioma of Usuario
   * @returns The original Usuario(this object)
   */
  setIdioma(value) {
    //object based
   ...
   * @method
   * @returns {Date} The FechaEntrada of Usuario
   */
  getFechaEntrada() {
   ...
   * @method
   * @param {Date} value - The FechaEntrada of Usuario
   * @returns The original Usuario(this object)
   */
  ...
  setFechaEntrada(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaEntrada = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
   ...
   * @method
   * @returns {Grupos} The Puesto of Usuario
   */
  getPuesto() {
    return this.Puesto;
  }
   ...
   * @method
   * @param {Grupos} value - The Puesto of Usuario
   * @returns The original Usuario(this object)
   */
  setPuesto(value) {
    //object based
    if (value == null || value == undefined || value instanceof Grupos)
      this.Puesto = value;
    else throw new Error("Wrong value type");
    return this;
  }
   ...
   * @method
   * @returns {Grupos} The Departamento of Usuario
   */
  getDepartamento() {
   ...
   * @method
   * @param {Grupos} value - The Departamento of Usuario
   * @returns The original Usuario(this object)
   */
   ...
   * @method
   * @returns {Grupos} The Directivo of Usuario
   */
  getDirectivo() {
   ...
   * @method
   * @param {Grupos} value - The Directivo of Usuario
   * @returns The original Usuario(this object)
   */
  setDirectivo(value) {
    //object based
   ...
   * @method
   * @returns {Date} The FechaInicioPuestoActual of Usuario
   */
   ...
   * @method
   * @param {Date} value - The FechaInicioPuestoActual of Usuario
   * @returns The original Usuario(this object)
   */
  ...
  setFechaInicioPuestoActual(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaInicioPuestoActual = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
   ...
   * @method
   * @returns {Date} The FechaFinPeriodoPrueba of Usuario
   */
   ...
   * @method
   * @param {Date} value - The FechaFinPeriodoPrueba of Usuario
   * @returns The original Usuario(this object)
   */
  ...
  setFechaFinPeriodoPrueba(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaFinPeriodoPrueba = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
   ...
   * @method
   * @returns {Date} The FechaFinContrato of Usuario
   */
  getFechaFinContrato() {
   ...
   * @method
   * @param {Date} value - The FechaFinContrato of Usuario
   * @returns The original Usuario(this object)
   */
  ...
  setFechaFinContrato(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaFinContrato = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
   ...
   * @method
   * @returns {Date} The FechaEfectoSalario of Usuario
   */
   ...
   * @method
   * @param {Date} value - The FechaEfectoSalario of Usuario
   * @returns The original Usuario(this object)
   */
  ...
  setFechaEfectoSalario(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaEfectoSalario = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
  ...
  /**
   * Get the Impuesto of Usuario
   * @method
   * @returns {string} The Impuesto of Usuario
   */
  getImpuesto() {
    return this.Impuesto;
  }
  /**
   * Sets the Impuesto of Usuario
   * @method
   * @param {string} value - The Impuesto of Usuario
   * @returns The original Usuario(this object)
   */
   ...
   * @method
   * @returns {Date} The FechaRenovacionVacaciones of Usuario
   */
   ...
   * @method
   * @param {Date} value - The FechaRenovacionVacaciones of Usuario
   * @returns The original Usuario(this object)
   */
  ...
  setFechaRenovacionVacaciones(value) {
    if (value == null || value == undefined || value instanceof Date) {
      ...
      this.FechaRenovacionVacaciones = new Date(Date.parse(value));
    } else {
      throw new Error("Wrong value type");
    }
    return this;
...
export class Catalogo_Idioma {
  ...
  /**
   * Crea un nuevo objeto Catalogo_Idioma
   * @method
   * @returns {Promise<Response>}
   */
  crear() {
    return new Promise((resolve, reject) => {
      createCatalogo_Idioma(this)
        .then((response) => {
          this.ID = response.value;
          resolve(response);
        })
  ...
  /**
   * Busca Catalogo_Idioma's con las mismas propiedades que este objeto
   * @method
   * @returns {Promise<Response>}
   */
  searchLikeMe() {
    return Catalogo_Idioma.buscar(this);
  }
  /**
   * Busca Catalogo_Idioma's, puedes usar {qwery:"<mysqlquery>"} o {qwery:"<mysqlquery>",graphql="<propiedades>"}
   * @method
   * @returns {Promise<Response>}
   */
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findCatalogo_Idioma(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
            newArray.push(new Catalogo_Idioma(element))
          );
          response.Value = newArray;
          resolve(response);
        })
  ...
  actualizar() {
    return new Promise((resolve, reject) => {
      resolve(updateCatalogo_Idioma(this));
    });
  }
  /**
   * Elimina la
   ...
   */
  eliminar() {
    return deleteCatalogo_Idioma({ id: this.ID.toString() });
  }
  main_Catalogo_Idioma(args) {
    return main_Catalogo_Idioma(args, this.ID);
  }

  /**
   * Get the Nombre of Catalogo_Idioma
   * @method
   * @returns {string} The Nombre of Catalogo_Idioma
   */
  getNombre() {
    return this.Nombre;
  }
  /**
   * Sets the Nombre of Catalogo_Idioma
   * @method
   * @param {string} value - The Nombre of Catalogo_Idioma
   * @returns The original Catalogo_Idioma(this object)
   */
  ...
  static getAll(callback) {
    return Catalogo_Idioma.buscar({ qwery: "" });
  }
  static getByID(id, callback) {
    return Catalogo_Idioma.buscar({ qwery: id.toString() });
  }
}
...
export class Catalogo_Categoria {
  ...
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findCatalogo_Categoria(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
...
export class Catalogo_Grupo {
  ...
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findCatalogo_Grupo(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
...
export class Catalogo_Directivos {
  ...
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findCatalogo_Directivos(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
...
export class Catalogo_Departamentos {
  ...
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findCatalogo_Departamentos(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
...
export class Catalogo_SubAreas {
  ...
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findCatalogo_SubAreas(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
...
export class Catalogo_ZonaHoraria {
  ...
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findCatalogo_ZonaHoraria(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
...
export class User {
  ...
  /**
   * Get the AddressID of User
   * @method
   * @returns {number} The AddressID of User
   */
  getAddressID() {
    return this.AddressID;
  }
  /**
   * Sets the AddressID of User
   * @method
   * @param {number} value - The AddressID of User
   * @returns The original User(this object)
   */
  ...
  /**
   * Get the RoleID of User
   * @method
   * @returns {number} The RoleID of User
   */
  getRoleID() {
    return this.RoleID;
  }
  /**
   * Sets the RoleID of User
   * @method
   * @param {number} value - The RoleID of User
   * @returns The original User(this object)
   */
...
export class Address {
  ...
  /**
   * Get the AddressTypeID of Address
   * @method
   * @returns {number} The AddressTypeID of Address
   */
  getAddressTypeID() {
    return this.AddressTypeID;
  }
  /**
   * Sets the AddressTypeID of Address
   * @method
   * @param {number} value - The AddressTypeID of Address
   * @returns The original Address(this object)
   */
  ...
  setAddressTypeID(value) {
    if (value == null || value == undefined || typeof value === "number") {
      ...
      if (isNaN(parsedValue)) {
        ...
        this.AddressTypeID = parsedValue;
      }
    } else {
      throw new Error("Wrong value type");
    }
...
export class Attachment {
  ...
  /**
   * Busca Attachment's con las mismas propiedades que este objeto
   * @method
   * @returns {Promise<Response>}
   */
  searchLikeMe() {
    return Attachment.buscar(this);
  }
  /**
   * Busca Attachment's, puedes usar {qwery:"<mysqlquery>"} o {qwery:"<mysqlquery>",graphql="<propiedades>"}
   * @method
   * @returns {Promise<Response>}
   */
  static buscar(args, graphql) {
    return new Promise((resolve, reject) => {
      ...
      findAttachment(args, graphql)
        .then((response) => {
          const newArray = [];
          response.Value.forEach((element) =>
            newArray.push(new Attachment(element))
          );
          response.Value = newArray;
          resolve(response);
        })
   ...
   */
  eliminar() {
    return deleteAttachment({ id: this.ID.toString() });
  }
  main_Attachment(args) {
    return main_Attachment(args, this.ID);
  }

  /**
   * Get the FileName of Attachment
   * @method
   * @returns {string} The FileName of Attachment
   */
  getFileName() {
    return this.FileName;
  }
  /**
   * Sets the FileName of Attachment
   * @method
   * @param {string} value - The FileName of Attachment
   * @returns The original Attachment(this object)
   */
   ...
   * @method
   * @param {string} value - The Type of Attachment
   * @returns The original Attachment(this object)
   */
   ...
   * @method
   * @returns {number} The Size of Attachment
   */
  getSize() {
    return this.Size;
  }
   ...
   * @method
   * @param {number} value - The Size of Attachment
   * @returns The original Attachment(this object)
   */
...
function findDevice(SearchQuery, model = null) {
  ...
  var body = { qwery: SearchQuery };
  if (model != null && model != "") {
    body = { qwery: SearchQuery, graphql: JSON.stringify(model) };
  }
...
function findGrupos(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function assingLogotipoFiletoGrupos(body, id, callback) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Grupos/LogotipoFile/assing";
  return postPromise(url, removeEmptyValues({ data: body, parent: id }));
}

function assingCabeceraFiletoGrupos(body, id, callback) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Grupos/CabeceraFile/assing";
  return postPromise(url, removeEmptyValues({ data: body, parent: id }));
}
...
function findCompania(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function assingIdiomatoCompania(body, id, callback) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Compania/Idioma/assing";
  return postPromise(url, removeEmptyValues({ data: body, parent: id }));
}

function assingZonaHorarialtoCompania(body, id, callback) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Compania/ZonaHorarial/assing";
  return postPromise(url, removeEmptyValues({ data: body, parent: id }));
}

function assingLogo1toCompania(body, id, callback) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Compania/Logo1/assing";
  return postPromise(url, removeEmptyValues({ data: body, parent: id }));
}

function assingLogo2toCompania(body, id, callback) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Compania/Logo2/assing";
  return postPromise(url, removeEmptyValues({ data: body, parent: id }));
}
...
function findNoticia(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function assingLogotoNoticia(body, id, callback) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Noticia/Logo/assing";
  return postPromise(url, removeEmptyValues({ data: body, parent: id }));
}
...
function findContrato(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findTareaOnBoarding(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findCargo(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findRegistroAusencia(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findAusencia(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function addGrupostoAusencia(body, id, callback) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Ausencia/Grupos/add";
  return postPromise(url, removeEmptyValues({ data: body, parent: id }));
}

function findComentario(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findRegistro(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findConfiguracionRetardos(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findJornadaExcepcion(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findJornada(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findConfiguracionJornadaEspecifica(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findViviendaHabitual(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "ViviendaHabitual/";
  var body = { qwery: SearchQuery };
  if (model != null && model != "") {
    body = { qwery: SearchQuery, graphql: JSON.stringify(model) };
  }
...
function updateViviendaHabitual(body) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function deleteViviendaHabitual(body) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function createViviendaHabitual(body) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findContacto(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Contacto/";
  var body = { qwery: SearchQuery };
  if (model != null && model != "") {
    body = { qwery: SearchQuery, graphql: JSON.stringify(model) };
  }
...
function findUsuario(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function assingIdiomatoUsuario(body, id, callback) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Usuario/Idioma/assing";
  return postPromise(url, removeEmptyValues({ data: body, parent: id }));
}

function assingPuestotoUsuario(body, id, callback) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Usuario/Puesto/assing";
  return postPromise(url, removeEmptyValues({ data: body, parent: id }));
}

function assingDepartamentotoUsuario(body, id, callback) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Usuario/Departamento/assing";
  return postPromise(url, removeEmptyValues({ data: body, parent: id }));
}

function assingDirectivotoUsuario(body, id, callback) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Usuario/Directivo/assing";
  return postPromise(url, removeEmptyValues({ data: body, parent: id }));
}
...
function findCatalogo_Idioma(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Catalogo_Idioma/";
  var body = { qwery: SearchQuery };
  if (model != null && model != "") {
    body = { qwery: SearchQuery, graphql: JSON.stringify(model) };
  }
...
function updateCatalogo_Idioma(body) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function deleteCatalogo_Idioma(body) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function createCatalogo_Idioma(body) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findCatalogo_Categoria(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findCatalogo_Grupo(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findCatalogo_Directivos(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findCatalogo_Departamentos(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findCatalogo_SubAreas(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findCatalogo_ZonaHoraria(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findUser(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findAddress(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findAddressType(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findOrg(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findRole(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findApp(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
...
function findAttachment(SearchQuery, model = null) {
  //test if body is null (which MUST not be at this point)
  if (SearchQuery === null || typeof SearchQuery === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
  ...
  const url = moduleAddress + "Attachment/";
  var body = { qwery: SearchQuery };
  if (model != null && model != "") {
    body = { qwery: SearchQuery, graphql: JSON.stringify(model) };
  }
...
function updateAttachment(body) {
  //test if body is null (which MUST not be at this point)
  if (body === null || typeof body === "undefined") {
    const error = errorBuilderById(1);
    if (checkCallbackFailure(callback)) {
